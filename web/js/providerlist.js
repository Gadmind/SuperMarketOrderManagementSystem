...
function deleteProvider(obj) {
    $.ajax({
        type: "GET",
        url: path + "/provider/providerDel.action?proid=" + obj.attr("proid"),
        dataType: "json",
        success: function (data) {
            if (data == true) {//删除成功：移除删除行
                cancleBtn();
                obj.parents("tr").remove();
                window.location.href=path + "/provider/allProvider.action";
...
$(function () {
    $(".viewProvider").on("click", function () {
        ...
        var obj = $(this);
        window.location.href = path + "/provider/providerView.action?proid=" + obj.attr("proid");
    });

    $(".modifyProvider").on("click", function () {
        var obj = $(this);
        window.location.href = path + "/provider/providerModify.action?proid=" + obj.attr("proid");
    });
