...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/findBillByTerm.action">
				...
				<a href="${pageContext.request.contextPath }/PJC/providerAdd.action">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
